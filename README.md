...
- `GET /` — человеко-понятный веб-интерфейс каталога.
- `GET /ui/books/{book_id}` — карточка книги в веб-интерфейсе.
...
- `http://<IP_СЕРВЕРА>/` — обычный сайт библиотеки
- `http://<IP_СЕРВЕРА>/docs` — технический API Swagger
